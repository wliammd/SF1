...
* Found in anterior pituitary cells containing gonadotropins which produce luteinizing hormone (LH) or follicle-stimulating hormone (FSH), but not in other adenohypophyseal cell types (Asa 1996ref).
* Gonadotroph adenomas comprise the largest category of pituitary adenomas (ref McDonald 2017, Mete 2018)
...
*	LH and FSH immunostains also mark gonadotroph adenomas, but are much less sensitive (althought quite specific) for gonadotroph adenomas (ref Mete 2018)
